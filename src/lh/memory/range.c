...
lh_memory_range_set(lh_memory_range_t *self, lh_ptr begin, lh_ptr end) {
    lh_memory_range_pack(self, lh_addr_of(begin), lh_addr_of(end));
}
...
lh_memory_range_get_begin(const lh_memory_range_t *self) {
    lh_ptr begin;
    lh_memory_range_unpack(self, lh_addr_of(begin), lh_null);
    return begin;
}
...
lh_memory_range_get_end(const lh_memory_range_t *self) {
    lh_ptr end;
    lh_memory_range_unpack(self, lh_null, lh_addr_of(end));
    return end;
}
...
lh_memory_range_assign(lh_memory_range_t *self, const lh_memory_range_t *other) {
    ...
    lh_memory_range_unpack(other, lh_addr_of(other_begin), lh_addr_of(other_end));
    lh_memory_range_set(self, other_begin, other_end);
}

lh_void
lh_memory_range_clear(lh_memory_range_t *self) {
    const lh_memory_range_t other = lh_memory_range_empty_initializer();
...
lh_memory_range_clone(const lh_memory_range_t *self) {
    lh_memory_range_t r;
    lh_memory_range_unpack(self, lh_addr_of(r.first), lh_addr_of(r.second));
    return r;
}

lh_void
lh_memory_range_dup(const lh_memory_range_t *self, lh_memory_range_t *other) {
    const lh_memory_range_t r = lh_memory_range_clone(self);
    return lh_memory_range_assign(other, lh_addr_of(r));
}

lh_void
lh_memory_range_dup_v(const lh_memory_range_t *self, lh_memory_range_t *other) {
    const lh_memory_range_t r = lh_memory_range_clone(self);
    return lh_memory_range_assign_v(other, lh_addr_of(r));
}

lh_memory_range_t
lh_memory_range_clone_v(const lh_memory_range_t *self) {
    lh_memory_range_t r;
    lh_memory_range_dup_v(self, lh_addr_of(r));
    return r;
}
...
lh_memory_range_init_by_empty(lh_memory_range_t *self) {
    const lh_memory_range_t other = lh_memory_range_empty_initializer();
    lh_memory_range_assign(self, lh_addr_of(other));
}
...
lh_memory_range_get_state(const lh_memory_range_t *self) {
    ...
    lh_memory_range_unpack(self, lh_addr_of(begin), lh_addr_of(end));
...
lh_memory_range_make(lh_ptr begin, lh_ptr end) {
    lh_memory_range_t r;
    lh_memory_range_init(lh_addr_of(r), begin, end);
    return r;
}

lh_memory_range_t
lh_memory_range_make_by_empty(lh_void) {
    lh_memory_range_t r;
    lh_memory_range_init_by_empty(lh_addr_of(r));
    return r;
}
...
lh_memory_range_make_or_empty(lh_ptr begin, lh_ptr end) {
    lh_runtime_try(e) {
        lh_memory_range_t r = lh_memory_range_make_v(begin, end);
        lh_runtime_try_return(r);
    }
    return lh_memory_range_make_by_empty();
}
...
lh_bool_t
lh_memory_range_is_sliceable(const lh_memory_range_t *self, lh_uoffset_t offset,
                             lh_uoffset_t size) {
...
lh_memory_range_slice_or_empty(const lh_memory_range_t *self, lh_uoffset_t offset,
                               lh_uoffset_t size) {
    lh_runtime_try(e) {
        lh_memory_range_t r = lh_memory_range_slice(self, offset, size);
        lh_runtime_try_return(r);
    }
    return lh_memory_range_make_by_empty();
}
...
lh_memory_range_get_ptr(const lh_memory_range_t *self, lh_uoffset_t offset, lh_bool_t from_back) {
    return from_back ? lh_memory_range_get_ptr_from_back(self, offset)
...
lh_memory_range_get_value(const lh_memory_range_t *self, lh_uoffset_t offset, lh_bool_t from_back) {
    return lh_ptr_deref(lh_ptr_cast(lh_byte_t, lh_memory_range_get_ptr(self, offset, from_back)));
}

lh_void
lh_memory_range_set_value(lh_memory_range_t *self, lh_uoffset_t offset, lh_byte_t value,
                          lh_bool_t from_back) {
    lh_ptr_deref(lh_ptr_cast(lh_byte_t, lh_memory_range_get_ptr(self, offset, from_back))) = value;
}
...
lh_memory_range_contains_ptr(const lh_memory_range_t *self, const lh_ptr ptr) {
    ...
    lh_memory_range_unpack_v(self, lh_addr_of(begin), lh_addr_of(end));
    return lh_interval_ropen_contains_value(begin, end, ptr);
}

lh_bool_t
lh_memory_range_contains_range(const lh_memory_range_t *self, const lh_ptr begin,
                               const lh_ptr end) {
    lh_ptr self_begin;
    lh_ptr self_end;

    lh_memory_range_unpack_v(self, lh_addr_of(self_begin), lh_addr_of(self_end));
...
lh_memory_range_contains(const lh_memory_range_t *self, const lh_memory_range_t *other) {
    ...
    lh_memory_range_unpack_v(other, lh_addr_of(other_begin), lh_addr_of(other_end));
...
lh_memory_range_equals_range(const lh_memory_range_t *self, const lh_ptr begin, const lh_ptr end) {
    ...
    lh_memory_range_unpack(self, lh_addr_of(self_begin), lh_addr_of(self_end));
...
lh_bool_t
lh_memory_range_overlaps_range(const lh_memory_range_t *self, const lh_ptr begin,
                               const lh_ptr end) {
    lh_ptr self_begin;
    lh_ptr self_end;
...
lh_memory_range_pack_v(lh_memory_range_t *self, lh_ptr *begin, lh_ptr *end) {
    lh_memory_range_t r = lh_memory_range_clone_v(self);
    lh_memory_range_pack(lh_addr_of(r), begin, end);
    lh_memory_range_assign_v(self, lh_addr_of(r));
}
...
lh_ptr
lh_memory_range_rcompare_range(const lh_memory_range_t *self, const lh_ptr begin,
                               const lh_ptr end) {
    lh_ptr self_begin;
    lh_ptr self_end;
