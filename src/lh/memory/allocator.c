...
lh_memory_allocator_alloc(lh_memory_allocator_t *self, lh_usize_t size)
{
    ...
    lh_assert_runtime_if_not(alloc_cb, lh_runtime_error_code_allocator_function_not_initialized);

    lh_ptr ptr = alloc_cb(size);
    lh_assert_runtime_if_not(ptr, lh_runtime_error_code_memory_not_allocated);
...
lh_memory_allocator_dealloc(lh_memory_allocator_t *self, lh_ptr ptr)
{
    ...
    lh_assert_runtime_if_not(dealloc_cb, lh_runtime_error_code_deallocator_function_not_initialized);
