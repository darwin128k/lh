...
lh_memory_bounds_slice_get_begin(const lh_memory_bounds_slice_t *self)
{
    ...
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_begin(s));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_data(s));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_end(s));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_is_uninitialized(s);
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_is_initialized(s);
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_is_forward(s);
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_is_backward(s);
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_is_valid(s);
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_begin_v(s));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_end_v(s));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_contains_of(s, begin, end);
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_ptr_from_begin(s, offset));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_ptr_from_end(s, offset));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_first_ptr(s));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_last_ptr(s));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_get_ptr(s, offset));
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_next_ptr(s, ptr);
}
...
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_prev_ptr(s, ptr);
}
...
lh_bool_t
lh_memory_bounds_slice_overlaps_range(const lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                      const lh_ptr end)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_overlaps_range(s, begin, end);
}
...
lh_bool_t
lh_memory_bounds_slice_equals_range(const lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                    const lh_ptr end)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_memory_view_slice_equals_range(s, begin, end);
}
                              ...
                              const lh_memory_bounds_slice_t *other)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    const lh_memory_view_slice_t *o = lh_ptr_ccast(lh_memory_view_slice_t, other);
    return lh_memory_view_slice_equals(s, o);
}

lh_ptr
lh_memory_bounds_slice_copy_range(lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                  const lh_ptr end)
{
    lh_ptr self_begin;
    lh_ptr self_end;

    self_begin = lh_memory_bounds_slice_get_begin_v(self);


    self_end = lh_memory_bounds_slice_get_end_v(self);
    return lh_memory_raw_copy(self_begin, lh_ptr_add_by_offset_unsafe(lh_void, self_end, 1U), begin,
                              lh_ptr_add_by_offset_unsafe(lh_void, end, 1U));
}

lh_ptr
lh_memory_bounds_slice_copy(lh_memory_bounds_slice_t *self, const lh_memory_bounds_slice_t *other)
{
    lh_ptr other_begin;
    lh_ptr other_end;

    other_begin = lh_memory_bounds_slice_get_begin_v(other);


    other_end = lh_memory_bounds_slice_get_end_v(other);
    return lh_memory_bounds_slice_copy_range(self, other_begin, other_end);
}

lh_ptr
lh_memory_bounds_slice_move_range(lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                  const lh_ptr end)
{
    lh_ptr self_begin;
    lh_ptr self_end;
    ...
    self_end = lh_memory_bounds_slice_get_end_v(self);
    return lh_memory_raw_move(self_begin, lh_ptr_add_by_offset_unsafe(lh_void, self_end, 1U), begin,
                              lh_ptr_add_by_offset_unsafe(lh_void, end, 1U));
}

lh_ptr
lh_memory_bounds_slice_move(lh_memory_bounds_slice_t *self, const lh_memory_bounds_slice_t *other)
{
    lh_ptr other_begin;
    lh_ptr other_end;
    ...
    other_end = lh_memory_bounds_slice_get_end_v(other);
    return lh_memory_bounds_slice_move_range(self, other_begin, other_end);
}

lh_ptr
lh_memory_bounds_slice_find_range(const lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                  const lh_ptr end)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_find_range(s, begin, end));
}

lh_ptr
lh_memory_bounds_slice_find(const lh_memory_bounds_slice_t *self,
                            const lh_memory_bounds_slice_t *other)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    const lh_memory_view_slice_t *o = lh_ptr_ccast(lh_memory_view_slice_t, other);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_find(s, o));
}

lh_ptr
lh_memory_bounds_slice_rfind_range(const lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                   const lh_ptr end)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_rfind_range(s, begin, end));
}

lh_ptr
lh_memory_bounds_slice_rfind(const lh_memory_bounds_slice_t *self,
                             const lh_memory_bounds_slice_t *other)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    const lh_memory_view_slice_t *o = lh_ptr_ccast(lh_memory_view_slice_t, other);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_rfind(s, o));
}

lh_ptr
lh_memory_bounds_slice_compare_range(const lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                     const lh_ptr end)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_compare_range(s, begin, end));
}

lh_ptr
lh_memory_bounds_slice_compare(const lh_memory_bounds_slice_t *self,
                               const lh_memory_bounds_slice_t *other)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    const lh_memory_view_slice_t *o = lh_ptr_ccast(lh_memory_view_slice_t, other);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_compare(s, o));
}

lh_ptr
lh_memory_bounds_slice_rcompare_range(const lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                      const lh_ptr end)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_rcompare_range(s, begin, end));
}

lh_ptr
lh_memory_bounds_slice_rcompare(const lh_memory_bounds_slice_t *self,
                                const lh_memory_bounds_slice_t *other)
{
    const lh_memory_view_slice_t *s = lh_ptr_ccast(lh_memory_view_slice_t, self);
    const lh_memory_view_slice_t *o = lh_ptr_ccast(lh_memory_view_slice_t, other);
    return lh_cast_const(lh_ptr, lh_memory_view_slice_rcompare(s, o));
}

lh_ptr
lh_memory_bounds_slice_fill(lh_memory_bounds_slice_t *self, lh_byte_t value)
{
    lh_ptr begin;
    lh_ptr end;

    begin = lh_memory_bounds_slice_get_begin_v(self);


    end = lh_memory_bounds_slice_get_end_v(self);
    return lh_memory_raw_set(begin, lh_ptr_add_by_offset_unsafe(lh_void, end, 1U), value);
}

lh_ptr
lh_memory_bounds_slice_fill_pattern_range(lh_memory_bounds_slice_t *self, const lh_ptr begin,
                                          const lh_ptr end)
{
    lh_ptr self_begin;
    lh_ptr self_end;
    ...
    self_end = lh_memory_bounds_slice_get_end_v(self);
    return lh_memory_raw_set_pattern(self_begin, lh_ptr_add_by_offset_unsafe(lh_void, self_end, 1U),
                                     begin, lh_ptr_add_by_offset_unsafe(lh_void, end, 1U));
}

lh_ptr
lh_memory_bounds_slice_fill_pattern(lh_memory_bounds_slice_t *self,
                                    const lh_memory_bounds_slice_t *other)
{
    lh_ptr other_begin;
    lh_ptr other_end;
    ...
    other_end = lh_memory_bounds_slice_get_end_v(other);
    return lh_memory_bounds_slice_fill_pattern_range(self, other_begin, other_end);
}

lh_void
lh_memory_bounds_slice_set(lh_memory_bounds_slice_t *self, lh_ptr begin, lh_ptr end)
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    lh_memory_view_slice_set(s, begin, end);
}
...
lh_memory_bounds_slice_assign(lh_memory_bounds_slice_t *self, const lh_memory_bounds_slice_t *other)
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    const lh_memory_view_slice_t *o = lh_ptr_ccast(lh_memory_view_slice_t, other);
    lh_memory_view_slice_assign(s, o);
}
                                ...
                                const lh_memory_bounds_slice_t *other)
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    const lh_memory_view_slice_t *o = lh_ptr_ccast(lh_memory_view_slice_t, other);
    lh_memory_view_slice_assign_v(s, o);
}
...
lh_memory_bounds_slice_make_v(lh_ptr begin, lh_ptr end)
{
    ...
    lh_assert_runtime_ifn(lh_memory_bounds_slice_is_valid(lh_addr_of(slice)),
...
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    lh_memory_view_slice_t *o = lh_ptr_cast(lh_memory_view_slice_t, other);
    lh_memory_view_slice_swap(s, o);
}
...
lh_memory_bounds_slice_swap_v(lh_memory_bounds_slice_t *self, lh_memory_bounds_slice_t *other)
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    lh_memory_view_slice_t *o = lh_ptr_cast(lh_memory_view_slice_t, other);
    lh_memory_view_slice_swap_v(s, o);
}
...
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    lh_memory_view_slice_set_by_size(s, begin, size);
}
                                      ...
                                      lh_memory_bounds_slice_t *other)
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    lh_memory_view_slice_t *o = lh_ptr_cast(lh_memory_view_slice_t, other);
    lh_memory_view_slice_swap_and_clear(s, o);
}
...
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    lh_memory_view_slice_init(s, begin, end);
}
...
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    lh_memory_view_slice_init_by_size(s, begin, size);
}
...
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    lh_memory_view_slice_init_empty(s);
}
                                     ...
                                     const lh_memory_bounds_slice_t *other)
{
    lh_memory_view_slice_t *s = lh_ptr_cast(lh_memory_view_slice_t, self);
    const lh_memory_view_slice_t *o = lh_ptr_ccast(lh_memory_view_slice_t, other);
    lh_memory_view_slice_init_by_other(s, o);
}
...
{
    lh_assert_runtime_ifn(lh_memory_bounds_slice_contains_range(self, begin, end),
...
{
    const lh_usize_t total = lh_memory_bounds_slice_get_size(self);
    lh_assert_runtime_ifn(lh_math_le(left, total), lh_runtime_error_code_out_of_range);
