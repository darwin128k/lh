...
lh_memory_bounds_slice_get_begin(const lh_memory_bounds_slice_t *self) {
    lh_ptr begin;
    lh_memory_bounds_slice_unpack(self, lh_addr_ref(begin), lh_null);
    return begin;
}
...
lh_memory_bounds_slice_get_end(const lh_memory_bounds_slice_t *self) {
    lh_ptr end;
    lh_memory_bounds_slice_unpack(self, lh_null, lh_addr_ref(end));
    return end;
}
...
lh_memory_bounds_slice_get_flags(const lh_memory_bounds_slice_t *self) {
    ...
    lh_void *begin, *end;
    lh_memory_bounds_slice_unpack(self, lh_addr_ref(begin), lh_addr_ref(end));
...
lh_memory_bounds_slice_get_begin_v(const lh_memory_bounds_slice_t *self) {
    lh_ptr begin;
    lh_memory_bounds_slice_unpack_v(self, lh_addr_ref(begin), lh_null);
    return begin;
}
...
lh_memory_bounds_slice_get_end_v(const lh_memory_bounds_slice_t *self) {
    lh_ptr end;
    lh_memory_bounds_slice_unpack_v(self, lh_null, lh_addr_ref(end));
    return end;
}
...
lh_memory_bounds_slice_get_size(const lh_memory_bounds_slice_t *self) {
    lh_void *begin, *end;
    lh_memory_bounds_slice_unpack_v(self, lh_addr_ref(begin), lh_addr_ref(end));
...
lh_memory_bounds_slice_contains_of(const lh_memory_bounds_slice_t *self, const lh_ptr begin,
    ...
    lh_memory_bounds_slice_unpack_v(self, lh_addr_ref(self_begin), lh_addr_ref(self_end));
...
lh_memory_bounds_slice_contains(const lh_memory_bounds_slice_t *self,
    ...
    lh_memory_bounds_slice_unpack_v(other, lh_addr_ref(other_begin), lh_addr_ref(other_end));
