...
lh_memory_view_set(lh_memory_view_t *self, const lh_ptr begin, const lh_ptr end) {
    lh_memory_view_pack(self, lh_addr_of(begin), lh_addr_of(end));
}
...
lh_memory_view_assign(lh_memory_view_t *self, const lh_memory_view_t *other) {
    ...
    lh_memory_view_unpack(other, lh_addr_of(other_begin), lh_addr_of(other_end));
...
lh_memory_view_clone(const lh_memory_view_t *self) {
    lh_memory_view_t v;
    lh_memory_view_unpack(self, lh_addr_of(v.first), lh_addr_of(v.second));
    return v;
}
...
lh_memory_view_t
lh_memory_view_make_by_empty(lh_void) {
...
lh_memory_view_t
lh_memory_view_slice_or_empty(const lh_memory_view_t *self, lh_uoffset_t offset,
                              lh_uoffset_t size) {
    lh_runtime_try(e) {
