...
lh_exception_catch_get_exception(lh_exception_catch_t *self)
{
    ...
    return lh_addr_of(self->exception);
}
...
{
    return lh_exception_get_error_as_const(lh_exception_catch_get_exception_as_const(self));
}
...
{
    return lh_exception_has_code(lh_exception_catch_get_exception_as_const(self), code);
}

lh_bool_t
lh_exception_catch_is_ok(const lh_exception_catch_t *self)
{
    return lh_exception_is_ok(lh_exception_catch_get_exception_as_const(self));
}

lh_bool_t
lh_exception_catch_is_failure(const lh_exception_catch_t *self)
{
    return lh_exception_is_failure(lh_exception_catch_get_exception_as_const(self));
}

lh_bool_t
lh_exception_catch_has_desc(const lh_exception_catch_t *self)
{
    return lh_exception_has_desc(lh_exception_catch_get_exception_as_const(self));
}

lh_bool_t
lh_exception_catch_is_empty(const lh_exception_catch_t *self)
{
    return lh_exception_is_empty(lh_exception_catch_get_exception_as_const(self));
}

lh_bool_t
lh_exception_catch_equals(const lh_exception_catch_t *self, const lh_exception_catch_t *other)
{
    return lh_exception_equals(lh_exception_catch_get_exception_as_const(self),
                               lh_exception_catch_get_exception_as_const(other));
}
...
{
    return lh_exception_has_same_code(lh_exception_catch_get_exception_as_const(self),
                                      lh_exception_catch_get_exception_as_const(other));
}
...
lh_exception_catch_has_diff_code(const lh_exception_catch_t *self,
                                 const lh_exception_catch_t *other)
{
    return lh_exception_has_diff_code(lh_exception_catch_get_exception_as_const(self),
                                      lh_exception_catch_get_exception_as_const(other));
}
