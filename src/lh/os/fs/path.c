...
{
    return lh_os_fs_path_span_as_view(
        lh_os_fs_path_parts_get_as_const(lh_os_fs_path_get_parts_as_const(self), index),
...
{
    return lh_os_fs_path_parts_is_empty(lh_os_fs_path_get_parts_as_const(self));
}

lh_usize_t
lh_os_fs_path_get_part_count(const lh_os_fs_path_t *self)
{
    return lh_os_fs_path_parts_get_size(lh_os_fs_path_get_parts_as_const(self));
}
...
lh_os_fs_path_clear(lh_os_fs_path_t *self)
{
    ...
    lh_os_fs_path_parts_clear(lh_os_fs_path_get_parts(self));
}
...
lh_os_fs_path_init(lh_os_fs_path_t *self)
{
    ...
    lh_os_fs_path_parts_init(lh_os_fs_path_get_parts(self));
}
...
lh_os_fs_path_deinit(lh_os_fs_path_t *self)
{
    ...
    lh_os_fs_path_parts_deinit(lh_os_fs_path_get_parts(self));
}
...
lh_os_fs_path_assign(lh_os_fs_path_t *self, const lh_os_fs_path_t *other)
{
    ...
    lh_os_fs_path_parts_assign(lh_os_fs_path_get_parts(self),
                              lh_os_fs_path_get_parts_as_const(other));
}
