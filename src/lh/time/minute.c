...
{
    lh_ullong_t cur = (lh_ullong_t)lh_time_minute_get(self);

    *self = (lh_time_minute_t)lh_interval_closed_unsigned_sub_wrap_value(
        cur, (lh_ullong_t)value, (lh_ullong_t)0, (lh_ullong_t)LH_TIME_MINUTE_MAX);
