...
static lh_bool_t
lh_str_ptr_split_emit(lh_str_cptr str, lh_usize_t str_size, lh_usize_t start, lh_str_cptr delim_at,
                      ...
                      lh_str_cptr *field, lh_usize_t *field_size, lh_bool_t *had_delim)
{
    ...
    return lh_str_ptr_split_emit(str, str_size, start,
                                 lh_str_ptr_find_of_char(str + start, str_size - start, delim), pos,
                                 field, field_size, had_delim);
}
                         ...
                         lh_bool_t *had_delim)
{
    ...
    return lh_str_ptr_split_emit(str, str_size, start, delim_at, pos, field, field_size,
                                 had_delim);
}
