                            ...
                            lh_usize_t src_size, lh_bool_t ignore_case)
{
    ...
    {
        return LH_STR_RAW_INVALID;
    }

    const lh_str_ptr ptr = lh_str_raw_find(str, str_size, src, src_size, ignore_case);
                               ...
                               lh_usize_t src_size)
{
    ...
    {
        if (lh_null_eq(lh_str_raw_compare_by_ignore_case(str + i, src_size, src, src_size)))
        {
            return str + i;
        }
    }
                        ...
                        lh_usize_t whitespace_size)
{
    ...
    lh_str_raw_move(str, trimmed_size + 1, str + offset, trimmed_size + 1);
    return str;
}
