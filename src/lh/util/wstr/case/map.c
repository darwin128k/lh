...
static const lh_usize_t m_wchar_to_lower_table_size = lh_array_ptr_get_size(m_wchar_to_lower_table);
...
static const lh_usize_t m_wchar_to_upper_table_size = lh_array_ptr_get_size(m_wchar_to_upper_table);
