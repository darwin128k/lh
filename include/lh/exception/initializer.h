...
/**
 * @def lh_exception_initializer(error, site)
 ...
 * @param site  `const lh_runtime_check_site_t *`, or ::lh_null.
 *
 * Example usage:
 * @code{.c}
 * static const lh_runtime_check_site_t site = {__FILE__, __func__, "x > 0",
 ...
 * @endcode
 */
#define lh_exception_initializer(error, site) lh_initializer(error, site)
