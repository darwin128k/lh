 ...
 *
 * Expands to ::lh_memory_range_initializer with half-open bounds semantics
 * <tt>[begin, end)</tt>.
 *
 ...
 */
#define lh_memory_view_initializer(begin, end) lh_memory_range_initializer(begin, end)

/**
 * @def lh_memory_view_empty_initializer()
 * @brief Initializer with both endpoints null (uninitialized pattern).
 *
 * Expands to ::lh_memory_range_empty_initializer.
 *
 * @see lh_memory_view_initializer
 * @see lh_memory_range_empty_initializer
 */
#define lh_memory_view_empty_initializer() lh_memory_range_empty_initializer()
