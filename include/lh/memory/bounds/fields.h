/**
 * @file fields.h
 * @brief Macro for declaring memory-bounds endpoint fields (`first` / `second`).
 *
...
#ifndef LH_MEMORY_BOUNDS_FIELDS_H
#define LH_MEMORY_BOUNDS_FIELDS_H
