 ...
 * @p type_size as the @c type_size field, and <tt>(end - begin) / type_size</tt> as the
 * cached @c size field — computed here, once, rather than left for the first read to derive.
 *
