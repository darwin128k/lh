 ...
 * ::lh_os_error_desc_make, or ::lh_os_error_desc_from_cstr and do not
 * pick the view type.
...
/**
 * @brief Description view over a narrow C string @p text.
 *
 * When ::LH_LIBRARY_OPTION_OS_WERROR is on, @p text is converted to wide.
 * @p text may be ::lh_null (empty description).
 */
LH_ATTRIBUTE_SYMBOL
lh_os_error_desc_t
