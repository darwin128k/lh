 ...
 * (::LH_OS_NET_SOCKET_HANDLE_INVALID, `-1`) correct on every platform,
...
/**
 * @typedef lh_os_net_socket_handle_t
 * @brief Raw OS socket handle, stored by bit pattern.
 */
typedef lh_ssize_t lh_os_net_socket_handle_t;

/**
 * @def LH_OS_NET_SOCKET_HANDLE_INVALID
