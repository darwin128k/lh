/**
 * @file type.h
 * @brief Which transport protocol ::lh_os_net_socket_open creates.
 *
...
#ifndef LH_OS_NET_SOCKET_TYPE_H
#define LH_OS_NET_SOCKET_TYPE_H

#include <lh/numeric/fixed/types.h>

/**
 * @typedef lh_os_net_socket_type_t
 * @brief Discriminator for which transport protocol to open.
 *
 * Alias for ::lh_u8_t; canonical values are the `lh_os_net_socket_type_*`
 * constants below.
 */
typedef lh_u8_t lh_os_net_socket_type_t;

/**
 * @def lh_os_net_socket_type_tcp
 ...
 */
#define lh_os_net_socket_type_tcp 0U
