 ...
 *
 * Expands to `LH_UCHAR_INTERVAL.bounds.first`.
 */
#    define LH_UCHAR_T_MIN LH_UCHAR_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_UCHAR_INTERVAL.bounds.second`.
 */
#    define LH_UCHAR_T_MAX LH_UCHAR_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_USHORT_INTERVAL.bounds.first`.
 */
#    define LH_USHORT_T_MIN LH_USHORT_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_USHORT_INTERVAL.bounds.second`.
 */
#    define LH_USHORT_T_MAX LH_USHORT_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_UINT_INTERVAL.bounds.first`.
 */
#    define LH_UINT_T_MIN LH_UINT_INTERVAL.bounds.first
#endif // LH_UINT_T_MIN
 ...
 *
 * Expands to `LH_UINT_INTERVAL.bounds.second`.
 */
#    define LH_UINT_T_MAX LH_UINT_INTERVAL.bounds.second
#endif // LH_UINT_T_MAX
 ...
 *
 * Expands to `LH_ULONG_INTERVAL.bounds.first`.
 */
#    define LH_ULONG_T_MIN LH_ULONG_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_ULONG_INTERVAL.bounds.second`.
 */
#    define LH_ULONG_T_MAX LH_ULONG_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_ULLONG_INTERVAL.bounds.first`.
 */
#    define LH_ULLONG_T_MIN LH_ULLONG_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_ULLONG_INTERVAL.bounds.second`.
 */
#    define LH_ULLONG_T_MAX LH_ULLONG_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_SCHAR_INTERVAL.bounds.first`.
 */
#    define LH_SCHAR_T_MIN LH_SCHAR_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_SCHAR_INTERVAL.bounds.second`.
 */
#    define LH_SCHAR_T_MAX LH_SCHAR_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_SHORT_INTERVAL.bounds.first`.
 */
#    define LH_SHORT_T_MIN LH_SHORT_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_SHORT_INTERVAL.bounds.second`.
 */
#    define LH_SHORT_T_MAX LH_SHORT_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_SSHORT_INTERVAL.bounds.first`.
 */
#    define LH_SSHORT_T_MIN LH_SSHORT_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_SSHORT_INTERVAL.bounds.second`.
 */
#    define LH_SSHORT_T_MAX LH_SSHORT_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_SINT_INTERVAL.bounds.first`.
 */
#    define LH_SINT_T_MIN LH_SINT_INTERVAL.bounds.first
#endif // LH_SINT_T_MIN
 ...
 *
 * Expands to `LH_SINT_INTERVAL.bounds.second`.
 */
#    define LH_SINT_T_MAX LH_SINT_INTERVAL.bounds.second
#endif // LH_SINT_T_MAX
 ...
 *
 * Expands to `LH_INT_INTERVAL.bounds.first`.
 */
#    define LH_INT_T_MIN LH_INT_INTERVAL.bounds.first
#endif // LH_INT_T_MIN
 ...
 *
 * Expands to `LH_INT_INTERVAL.bounds.second`.
 */
#    define LH_INT_T_MAX LH_INT_INTERVAL.bounds.second
#endif // LH_INT_T_MAX
 ...
 *
 * Expands to `LH_SLONG_INTERVAL.bounds.first`.
 */
#    define LH_SLONG_T_MIN LH_SLONG_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_SLONG_INTERVAL.bounds.second`.
 */
#    define LH_SLONG_T_MAX LH_SLONG_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_LONG_INTERVAL.bounds.first`.
 */
#    define LH_LONG_T_MIN LH_LONG_INTERVAL.bounds.first
#endif // LH_LONG_T_MIN
 ...
 *
 * Expands to `LH_LONG_INTERVAL.bounds.second`.
 */
#    define LH_LONG_T_MAX LH_LONG_INTERVAL.bounds.second
#endif // LH_LONG_T_MAX
 ...
 *
 * Expands to `LH_SLLONG_INTERVAL.bounds.first`.
 */
#    define LH_SLLONG_T_MIN LH_SLLONG_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_SLLONG_INTERVAL.bounds.second`.
 */
#    define LH_SLLONG_T_MAX LH_SLLONG_INTERVAL.bounds.second
 ...
 *
 * Expands to `LH_LLONG_INTERVAL.bounds.first`.
 */
#    define LH_LLONG_T_MIN LH_LLONG_INTERVAL.bounds.first
 ...
 *
 * Expands to `LH_LLONG_INTERVAL.bounds.second`.
 */
#    define LH_LLONG_T_MAX LH_LLONG_INTERVAL.bounds.second
