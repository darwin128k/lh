...
{
    lh_exception_catch_t catch_frame = lh_exception_catch_initializer(42, lh_str_view_lit("msg"));
...
{
    const lh_exception_catch_t catch_frame = lh_exception_catch_initializer(7, lh_str_view_lit("seven"));
...
{
    const lh_exception_catch_t catch_frame = lh_exception_catch_initializer(9, lh_str_view_lit("nine"));
...
{
    const lh_exception_catch_t catch_frame = lh_exception_catch_initializer(1, lh_str_view_lit("desc"));

    EXPECT_STREQ(desc_cstr(lh_exception_catch_get_desc_or(&catch_frame, lh_str_view_lit("fallback"))), "desc");
}
...
{
    const lh_exception_catch_t catch_frame = lh_exception_catch_initializer(11, lh_str_view_lit("eleven"));
...
{
    const lh_exception_catch_t lhs = lh_exception_catch_initializer(21, lh_str_view_lit("same"));
    const lh_exception_catch_t rhs = lh_exception_catch_initializer(22, lh_str_view_lit("same"));
...
{
    const lh_exception_catch_t lhs = lh_exception_catch_initializer(21, lh_str_view_lit("lhs"));
    const lh_exception_catch_t rhs = lh_exception_catch_initializer(21, lh_str_view_lit("rhs"));
...
{
    LH_EXPECT_DEATH(lh_exception_catch_get_desc_or(nullptr, lh_str_view_lit("fallback")));
}
